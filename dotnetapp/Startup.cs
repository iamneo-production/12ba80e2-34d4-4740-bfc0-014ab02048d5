...
namespace dotnetapp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>{c.SwaggerDoc("v2", new OpenApiInfo { Title = "dotnetapp", Version = "v2" });});
        ...
        {   
            ...
            app.UseSwagger();  
            app.UseSwaggerUI(c =>{c.SwaggerEndpoint("/swagger/v2/swagger.json", "dotnetapp");});
